...
{
	ofstream out("../PlatformGame/saveFile/continueSave.json", ios::out | ios::trunc);
	...
	{
		std::cerr << "[!] Error writing ../PlatformGame/saveFile/continueSave.json.";
		std::cerr << e.what() << "\n";
	}
...
{
	ifstream in("../PlatformGame/saveFile/continueSave.json");
	// Testa se o arquivo existe
	if (!in.good())
	{
		throw "[!] ../PlatformGame/saveFile/continueSave.json file doesn't exist.";
		exit(EXIT_FAILURE);
	}
	...
	if (!in.tellg())
	{
		throw "[!] ../PlatformGame/saveFile/continueSave.json file is empty.";
		exit(EXIT_FAILURE);
	}
	...
	try {
		...
		std::cerr << "[!] Erro na leitura do arquivo ../PlatformGame/saveFile/continueSave.json." << std::endl;
